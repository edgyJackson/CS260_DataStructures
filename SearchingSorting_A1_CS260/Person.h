...
//OK to add code here
/**
 * @brief parsePerson turns a string into Person object
 * @param personString in format "ID, LastName, FirstNAme, ZipCode"
 * @return Person struct
 */
Person parsePerson(std::string personString);
...
void mergeFunc(Person* array, int low, int mid, int high, Person* temp); /* merge two halves using temp */
